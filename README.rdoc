...
This application can be used as a template to setup a new Rails 4 BDD/TDD test environment, with Spinach and RSpec frameworks (see Deployment instructions at the end of this page).
...
* How to run the test suite
  ...
  lsoave@ubuntu:~/rails/github/rails4-spinach-rspec$ spinach
  ...
  lsoave@ubuntu:~/rails/github/rails4-spinach-rspec$ 
